object program extends App {
  ...
  println(Typeclasses.testReversableString("testReverse"))
  println(Typeclasses.testSmashInt(5, 6))
  println(Typeclasses.testSmashDouble(2.5, 6.75))
  println(Typeclasses.testSmashString("Concat", "TestFunc"))
